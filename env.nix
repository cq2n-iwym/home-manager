  ...
  extraConfig = { config, pkgs, self, ... }:
    {
      ...
      home.sessionVariables.EDITOR = "nvimw";
      home.sessionVariables.AWS_PAGER = "";
      home.sessionVariables.AWS_DEFAULT_OUTPUT = "yaml";
      home.sessionVariables.AWS_CLI_AUTO_PROMPT = "on-partial";
      home.sessionVariables.AWS_VAULT_BACKEND = "pass";
      home.sessionVariables.AWS_VAULT_PASS_PREFIX = "aws-vault/";
      home.sessionVariables.DIRENV_LOG_FORMAT = "";
      home.sessionVariables.FZFW_FD_EXCLUDE_PATHS = ".git,.hg,.hie,dist-newstyle,__pycache__,Session.vim";
